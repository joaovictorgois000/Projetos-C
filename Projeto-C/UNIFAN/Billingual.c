...
void jogoTraducaoParaJogador(int idxJogador)
{
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        // prepara resposta do jogador e resposta correta para comparação
        char respLow[300];
        char inglLow[300];
        ...
        // Checa comando para voltar ao menu
        if (strcmp(respLow, "menu") == 0)
        {
            // salva pontos ganhos até agora e retorna ao menu
    ...
    // ao terminar toda a lista, adiciona os pontos da sessão à pontuação total
    jogadores[idxJogador].pontuacao += pontosSessao;
